...
- Trigger a dedicated security review before #102 only for a credible critical vulnerability, new public or untrusted-user exposure, secrets or privileged network/service integration, a material sandbox/authorization boundary change beyond the existing contained worker contract, or explicit user direction.
