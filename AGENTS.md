...
- Safety-critical code still receives independent exact-head functional/safety review before merge. Security-diff, repository-wide, and deep security scans are deferred until the final program gate at #102; they are not routine PR or packet-completion gates before then.
